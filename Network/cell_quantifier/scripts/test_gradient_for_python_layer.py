# See https://github.com/BVLC/caffe/pull/5157
# and http://stackoverflow.com/questions/41344168/what-is-a-python-layer-in-caffe/41481539#41481539
...
def make_net_from_python_layer(input_names_and_values, output_names, py_module, py_layer, param_str=None,
    ...
    for o, on in zip(itertools.repeat(outputs), output_names):
        ns.__setattr__(on, o)
