...
%\noindent For non-binary classification problems, a popular choice is the Softmax function, which assigns probabilities to each possible class that can be interpreted as ``soft'' labels %instead of outputting a hard label.
